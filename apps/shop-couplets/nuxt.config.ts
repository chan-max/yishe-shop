...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      title: '墨韵阁 · 传世名家手写与烫金春联定制平台 | MoYun Couplets',
      meta: [
        { name: 'keywords', content: '墨韵阁, 春联定制, 对联设计, 烫金门联, 楹联大吉, 万年红宣纸, 名家书法春联, 企业大门联' },
        { name: 'description', content: '墨韵阁专注于传世名家手写对联、烫金企业门联与创意新春楹联定制，采用特级万年红宣纸与耐候金墨。' },
        { property: 'og:title', content: '墨韵阁 · 传世名家春联定制' },
  ...
  site: {
    ...
    name: '墨韵阁 (MoYun Couplets)',
    description: '墨韵阁 - 专注于传统春联、烫金门联、企业定制楹联与创意手写对联设计定制平台'
  },
  runtimeConfig: {
    public: {
      siteName: '墨韵阁 (MoYun Couplets)',
