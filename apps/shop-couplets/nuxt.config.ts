...
export default defineNuxtConfig({
  ...
  // shop-couplets 专属独立 SEO 配置 (对联/春联专属独立站)
  site: {
    url: process.env.NUXT_PUBLIC_SITE_URL || 'https://couplets.1s.design',
    name: process.env.NUXT_PUBLIC_SITE_NAME || '衣设春联工坊 (Shop Couplets)',
    description: '衣设春联工坊 - 专注于传统春联、烫金门联、企业定制楹联与创意手写对联设计定制平台'
  },
  runtimeConfig: {
    public: {
      siteName: process.env.NUXT_PUBLIC_SITE_NAME || '衣设春联工坊 (Shop Couplets)',
