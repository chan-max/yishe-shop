...
const recommendedKeywords = ['dashboard', 'landing page', 'e-commerce', 'logo', 'card', 'icons']
...
const getProductImage = (product: any) => {
  ...
  if (Array.isArray(product.images) && product.images.length > 0) {
    const validImage = product.images.find((img: any) => img && typeof img === 'string' && img.trim() !== '' && img.startsWith('http'))
...
<template>
  <div class="min-h-screen bg-[#f7f5f2] px-4 py-8 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-[1560px]">
      ...
      <div class="sticky top-[58px] z-20 mt-6 rounded-[1.25rem] border border-stone-200 bg-white p-4 sm:p-5">
