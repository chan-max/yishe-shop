 ...
 * @LastEditTime: 2025-06-17 08:52:16
...
<template>
  <div class="overflow-x-hidden">
    ...
    <div v-if="shouldShowMenu" class="fixed bottom-6 right-6 z-[9999]">
      ...
      <div
        v-if="isOpen"
        class="absolute bottom-16 right-0 bg-white rounded-lg shadow-xl p-2 space-y-2 min-w-[200px] z-[9999]"
      >
        <NuxtLink
          to="/contact"
